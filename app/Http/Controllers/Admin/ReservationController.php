...
class ReservationController extends Controller
{
    ...
    public function store(ReservationStoreRequest $request)
    {
        ...
        
        {
            ...
            {
                return back()->with('warning','This table is already reserved for today');
            }
        }

        Reservation::create($request->validated());

        return to_route('admin.reservations.index')->with('success','New Reservation Created Successfully');
    }
